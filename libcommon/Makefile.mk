...
OBJ = asciitype.o ib_alloc.o ib_close.o ib_free.o ib_getlin.o ib_getw.o \
	...
	afterchar.o basename.o securestr.o strjoin.o getdir.o regexpr.o gmatch.o \
  utmpx.o memalign.o pathconf.o sigset.o signal.o sigrelse.o sighold.o sigignore.o \
...
strjoin.o: strjoin.c
	$(CC) -std=c99 $(CFLAGSU) $(CPPFLAGS) -I. -c strjoin.c
