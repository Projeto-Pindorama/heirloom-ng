...
char		*fromS;		/* stored here by sendmail for sendsurg */
size_t		fromSsize;
char		*fromU;		/* stored here by sendmail for sendsurg */
size_t		fromUsize;
...
char		*line;		/* holds a line of a letter in many places */
size_t		linesize;
...
char		*Rpath;		/* return path to sender of message */
size_t		Rpathsize;
